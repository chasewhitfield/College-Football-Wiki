...
int main()
{
	cout << "Welcome to the hub of all that is FBS College Football!" << endl;
	cout << "Our data was compiled by all FBS programs' rosters from 2005 onward as presented by the schools." << endl;
	cout << "We hope you enjoy finding all the information you'd like!" << endl;
	cout << "************************************************************************************************" << endl;
